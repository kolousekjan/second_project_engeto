...
function createCard(item) {
    var _a, _b, _c, _d;
    const poster = ((_a = item.show.image) === null || _a === void 0 ? void 0 : _a.medium) || ((_b = item.show.image) === null || _b === void 0 ? void 0 : _b.original) || "./images/movies-bg.jpeg";
    const title = item.show.name || "Bez názvu";
    const rating = (_d = (_c = item.show.rating) === null || _c === void 0 ? void 0 : _c.average) !== null && _d !== void 0 ? _d : "–";
...
if (form) {
    form.addEventListener("submit", (e) => {
        ...
        const q = ((_a = input === null || input === void 0 ? void 0 : input.value) === null || _a === void 0 ? void 0 : _a.trim()) || "girl";
